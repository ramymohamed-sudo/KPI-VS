...
def main():
    ...
    future_datetime_after_5_mins = datetime.now() + timedelta(seconds = 10)
    i=1
    while datetime.now() < future_datetime_after_5_mins:
